...
\newcommand{\numberOfLab}{13} % Лабораторная работа №X
\newcommand{\semestr}{2} % За X семестр
\newcommand{\distiplina}{ОАиП} % По дисциплине <<X>>
\newcommand{\labTitle}{Индексные файлы} % Тема: <<X>>
...
%<<<===Цель
\labgoal{Изучить принципы программирования с использованием индексных файлов.}
%===>>>
...
%<<<===Вывод ЛР
\labconclusion{Изучили принципы программирования с использованием индексных файлов.}
%===>>>
